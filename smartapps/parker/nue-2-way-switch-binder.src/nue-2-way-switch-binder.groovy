...
//    if (evt.value == "on" && switch2.currentValue("switch")[0] == "off") {
    if (evt.value == "on" && switch1.currentValue("switch") == "on") {
    	log.debug "switch 1 ON"
        log.debug switch2
        switch2.on()
    } else if (evt.value == "off" && switch1.currentValue("switch") == "off") // if (evt.value == "off" && switch2.currentValue("switch")[0] == "on") 
    {
...
def switchTwoHandler(evt) {
    if (evt.value == "on" && switch1.currentValue("switch") == "off") {
    	log.debug "switch 2 ON"           
        log.debug switch1
 		switch1.on()
    } else if (evt.value == "off" && switch1.currentValue("switch") == "on") 
    {
